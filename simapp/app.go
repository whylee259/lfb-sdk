...
func NewSimApp(
	...
	transferModule := transfer.NewAppModule(app.TransferKeeper, appCodec)
	...
	app.mm = module.NewManager(
		...
		evidence.NewAppModule(app.EvidenceKeeper, appCodec),
		ibc.NewAppModule(app.IBCKeeper, appCodec),
